...
public class Paciente {
    ...
    public Paciente(int codigoPaciente, String nombrePaciente, String apellidosPaciente, String sexo, Date fechaNacimiento, String direccionPaciente, String telefonoPersonal, Date fechaPrimeraVisita) {
    ...
    public void setNombrePaciente(String nombresPaciente) {
        this.nombrePaciente = nombresPaciente;
    }
